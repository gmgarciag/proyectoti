...
namespace :requests do
  ...
  task revisarStock: :environment do
		...
		if celulosa < 800
		  transaccion = RestClient.put 'http://moto.ing.puc.cl/banco/trx', {:monto => 1200000, :origen => '572aac69bdb6d403005fb04e', :destino => cuentaFabrica}.to_json, :content_type => 'application/json'
		  transaccionParseada = JSON.parse transaccion
		  idTrx = transaccionParseada["_id"]
