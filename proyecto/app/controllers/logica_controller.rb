...
=end
  ...
  def moverA_Despacho oc
    oc = params[:oc]
    sku = (Orden.find_by idOrden: oc).sku
    cantidad = (Orden.find_by idOrden: oc).cantidad
...
def llenarOrden
  ...
  idOrden = orden.idOC
  temp = RestClient.get 'http://mare.ing.puc.cl/oc/obtener/' +idOrden 
